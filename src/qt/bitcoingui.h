...
/**
  KatzCoin GUI main class. This class represents the main window of the KatzCoin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class KatzCoinGUI : public QMainWindow
{
    Q_OBJECT

public:
    explicit KatzCoinGUI(QWidget *parent = 0);
    ~KatzCoinGUI();
